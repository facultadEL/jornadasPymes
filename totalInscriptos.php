...
<table id="lista" align="center">
	...
	<?php	$true = 'true';	?>
	<tr>
		<td class="texto"><li><label>Escenario actual de las Pymes:</label></td><td class="total"><l1><?php echo $contarActividad1 = contarRegistro('actividad1','inscripto','actividad1='.$true);?></l1></li></td>
	</tr>
	<tr>
		<td class="texto"><li><label><l3>Rentabilidad de las pymes:</l3> el secreto no pasa por hacer más sino hacer lo correcto</label></td><td class="total"><l1><?php echo $contarActividad2 = contarRegistro('actividad2','inscripto','actividad2='.$true);?></l1></li></td>
	</tr>
	<tr>
		<td class="texto"><li><label>Taller Experiencias Casos Exitosos UTN</label></td><td class="total"><l1><?php echo $contarActividad3 = contarRegistro('actividad3','inscripto','actividad3='.$true);?></l1></li></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="texto"><li><label><l3>Crecimiento, Delegaci&oacute;n y direcci&oacute;n en las Pymes:</l3> Los roles del Fundador - Gerente General</label></td><td class="total"><l1><?php echo $contarActividad6 = contarRegistro('actividad6','inscripto','actividad6='.$true);?></l1></li></td>
	</tr>
	<tr>
		<td class="texto"><li><label><l3>Como emprender con &eacute;xito en la Argentina. Cadena de valor</label></td><td class="total"><l1><?php echo $contarActividad7 = contarRegistro('actividad7','inscripto','actividad7='.$true);?></l1></li></td>
	</tr>
	<tr>
		<td class="texto"><li><label>Taller Programa de Financiamiento y Creditos para Pymes</label></td><td class="total"><l1><?php echo $contarActividad8 = contarRegistro('actividad8','inscripto','actividad8='.$true);?></l1></li></td>
	</tr>
	<tr>
